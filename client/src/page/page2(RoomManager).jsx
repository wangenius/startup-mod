<div className="w-96 h-[874px] relative bg-stone-950 overflow-hidden">
  <div className="left-[63px] top-[421px] absolute inline-flex justify-start items-center gap-3">
    <div className="w-14 h-20 border-[0.40px] border-white/60" />
    <div className="w-14 h-20 border-[0.40px] border-white/60" />
    <div className="w-14 h-20 border-[0.40px] border-white/60" />
    <div className="w-14 h-20 border-[0.40px] border-white/60" />
  </div>
  <div className="left-[139px] top-[360px] absolute text-center justify-start text-white text-xl font-normal font-['Cactus_Classical_Serif'] leading-relaxed">输入团队暗号</div>
