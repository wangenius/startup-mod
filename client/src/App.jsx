...
const API_BASE = 'http://192.168.134.52:8000'
const WS_BASE = 'ws://192.168.134.52:8000'
  ...
  const handleWebSocketMessage = (message) => {
    switch (message.type) {
      ...
      case 'chat_message':
        ...
        break
      case 'game_action':
        addMessage(`🎯 ${message.data.player_name} 执行操作: ${message.data.action}`)
        break
      default:
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-center text-gray-800 mb-8">🎮 多人游戏大厅</h1>
        
        {/* 玩家信息和房间控制 */}
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">游戏大厅</h2>
          
          {!isJoined ? (
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">玩家名称</label>
                  <input
                    type="text"
                    value={playerName}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">房间ID</label>
                  <input
                    type="text"
                    value={roomId}
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">当前房间</label>
                  <div className="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50">
                    {currentRoom}
                  </div>
                </div>
        ...
        {isJoined && (
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
             ...
             <div className="bg-white rounded-lg shadow-lg p-6">
               <h2 className="text-2xl font-semibold mb-4 text-gray-700">在线玩家</h2>
          ...
          {/* 聊天区域 */}
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h2 className="text-2xl font-semibold mb-4 text-gray-700">消息记录</h2>
            ...
            <div className="h-80 overflow-y-auto border border-gray-200 rounded-lg p-4 mb-4 bg-gray-50">
              {messages.map(message => (
                ...
                >
                  <span className="font-medium">[{message.timestamp}]</span> {message.content}
                </div>
              ))}
