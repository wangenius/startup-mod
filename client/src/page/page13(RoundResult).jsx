<div className="w-96 h-[874px] relative bg-stone-950 overflow-hidden">
  ...
  <div className="w-80 left-[39px] top-[699px] absolute text-center justify-start text-white text-xl font-normal font-['Cactus_Classical_Serif'] leading-relaxed">第一个月，团队迎来一次曝光机会，在谨慎与激进中取得微妙平衡。你们被市场注意到了一点，但真正的认可仍需产品上线来证明自己。</div>
</div>