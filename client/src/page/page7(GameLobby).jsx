...
<div className="w-96 h-[874px] relative bg-stone-950 overflow-hidden">
  <div className="w-32 h-7 left-[136px] top-[357px] absolute">
    <div className="left-[8px] top-[2px] absolute text-center justify-start text-white text-xl font-normal font-['Cactus_Classical_Serif'] leading-relaxed">你的项目是...</div>
    <div className="w-px h-7 left-0 top-0 absolute bg-zinc-300" />
  </div>
  <div className="left-[169px] top-[531px] absolute text-center justify-start text-white/70 text-base font-normal font-['Cactus_Classical_Serif'] leading-relaxed">随机生成</div>
