  ...
  const getAvailableActions = (role) => {
    ...
    const actions = {
      CEO: [
        ...
        { id: 'funding_round', name: '启动融资', description: '寻求投资者进行融资' },
        { id: 'partnership', name: '建立合作关系', description: '与其他公司建立战略合作' },
        { id: 'pivot_strategy', name: '调整商业模式', description: '根据市场反馈调整商业模式' }
      ],
      CTO: [
        { id: 'develop_feature', name: '开发新功能', description: '开发产品核心功能' },
        { id: 'tech_architecture', name: '优化技术架构', description: '提升系统性能和稳定性' },
        { id: 'hire_developers', name: '招聘开发人员', description: '扩充技术团队' },
        { id: 'tech_research', name: '技术调研', description: '研究新技术和解决方案' }
      ],
      CMO: [
        { id: 'marketing_campaign', name: '营销推广', description: '制定和执行营销活动' },
        { id: 'brand_building', name: '品牌建设', description: '提升品牌知名度和影响力' },
        { id: 'user_acquisition', name: '用户获取', description: '通过各种渠道获取新用户' },
        { id: 'market_research', name: '市场调研', description: '分析市场趋势和竞争对手' }
      ],
      COO: [
        { id: 'optimize_operations', name: '优化运营', description: '提升运营效率和质量' },
        { id: 'scale_team', name: '团队扩张', description: '招聘和培训新员工' },
        { id: 'process_improvement', name: '流程改进', description: '优化内部工作流程' },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-xl p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-right">
              ...
              <div className="text-lg font-semibold text-blue-600">{playerRole}</div>
            </div>
          </div>
          ...
          {roundInfo && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h2 className="text-lg font-semibold text-blue-800 mb-2">📋 本轮情况</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-xl p-6">
            <h2 className="text-2xl font-semibold mb-4 text-gray-700">🎯 选择您的行动</h2>
            ...
            {!hasSubmitted ? (
                ...
                {selectedAction && (
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="详细说明您选择这个行动的原因和预期效果..."
                    />
                  </div>
                )}
              ...
              <div className="text-center py-8">
                ...
                <h3 className="text-xl font-semibold text-green-600 mb-2">行动已提交</h3>
          ...
          {/* 玩家状态 */}
          <div className="bg-white rounded-lg shadow-xl p-6">
            <h2 className="text-2xl font-semibold mb-4 text-gray-700">👥 玩家状态</h2>
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <div className={`text-sm ${
                        hasSubmittedAction ? 'text-green-600' : 'text-gray-400'
                      }`}>
        ...
        <div className="mt-6 bg-white rounded-lg shadow-xl p-6">
          <h2 className="text-xl font-semibold mb-4 text-gray-700">📊 游戏进度</h2>
