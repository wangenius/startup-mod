...
<div className="w-96 h-[874px] relative bg-stone-950 overflow-hidden">
  <img className="w-96 h-[536px] left-0 top-0 absolute" src="https://placehold.co/402x536" />
  <div className="w-80 left-[42px] top-[615px] absolute text-center justify-start text-white text-2xl font-normal font-['Cactus_Classical_Serif'] leading-loose">走出黑客松之后，团队正式成立刚满一个月，位于深圳南山一个创业园，产品概念已经基本确定，正在进行原型开发。<br/></div>
